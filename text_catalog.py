...
TEXT_CATEGORIES = OrderedDict({
    ...
    '💰 کیف پول': [
        ('wallet_overview', '💰 کیف پول شما\n\n👛 موجودی قابل استفاده: {wallet:,} تومان\n🔒 موجودی در انتظار: {locked:,} تومان\n\nℹ️ موجودی در انتظار، پس از اولین خرید واقعی و پولی توسط فردی که با لینک شما عضو شده، به\u200cصورت خودکار آزاد می\u200cشود.'),
        ('wallet_free_overview', '💰 موجودی قابل استفاده شما\n\n{wallet:,} تومان\n\nاین مبلغ را می\u200cتوانید برای خرید سرویس استفاده کنید.'),
        ('wallet_locked_overview', '🔒 موجودی در انتظار شما\n\n{locked:,} تومان\n\nاین مبلغ از دعوت دوستان به\u200cدست آمده و پس از اولین خرید واقعی و پولی توسط آن\u200cها، به\u200cصورت خودکار به موجودی قابل\u200cاستفاده شما اضافه می\u200cشود.'),
...
TEXT_CATEGORIES.setdefault("🎛 دکمه‌های کاربر", []).extend([
    ...
    ("config_delivery_guide", "🧑‍🦯 دریافت روش اتصال"),
    ("config_delivery_back", "🟢 بازگشت به منو اصلی"),
])
...
TEXT_CATEGORIES.setdefault("📦 تحویل سرویس", []).extend([
    ("service_delivery_text", "📦 سرویس شما آماده شد.\n\n📦 {service_label}\n\n🔗 لینک ساب:\n{link}"),
    ("service_delivery_test_text", "🎁 تست شما آماده شد.\n\n📦 {service_label}\n\n🔗 لینک ساب:\n{link}"),
    ("service_delivery_apps_button", "📱 لینک برنامه‌ها"),
    ("service_delivery_connection_button", "🧑‍🦯 روش اتصال"),
    ("service_delivery_test_apps_button", "📱 لینک برنامه‌ها"),
    ("service_delivery_test_connection_button", "🧑‍🦯 روش اتصال"),
    # 🆕 قالب تحویل دستی (ادمین لینک/کانفیگ را خودش می‌فرستد، بدون سفارش خودکار).
    # Placeholderهای مجاز: {name} {location} {days} {volume} {user_limit} {link} — مقدار {link} خودکار داخل کادر کد ارسال می‌شود.
    ("service_delivery_manual_text",
     "✅ سرویس با موفقیت ایجاد شد\n\n"
     "👤 نام کاربری سرویس : {name}\n"
     "🇺🇳 لوکیشن: {location}\n"
     "⏳ مدت زمان: {days}\n"
     "🗜 حجم سرویس: {volume}\n"
     "👤 تعداد کاربر: {user_limit}\n\n"
     "لینک اتصال:\n{link}\n\n"
