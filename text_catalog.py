...
TEXT_CATEGORIES.setdefault("📦 تحویل سرویس", []).extend([
    # قالب تحویل واقعی سرویس؛ همه‌ی متن، پیام ادمین و دو دکمه از پنل قابل ویرایش‌اند.
    ...
    ("service_delivery_test_text",
     ...
     "💬 پیام ادمین : {admin_message}\n\n"
     "برای دریافت اپلیکیشن یا آشنایی با نحوه متصل کردن کانفینگ، از دو گزینه زیر استفاده کنید 👇"),
    ("service_delivery_admin_message", "مرسی از اعتماد شما ❤️"),
    ("service_delivery_test_admin_message", "تست رایگان شما آماده است ❤️"),
